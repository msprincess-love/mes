...
import com.ktg.mes.md.domain.md.MdUnitMeasure;
...
public class MdUnitMeasureController extends BaseController {
    ...
    @PostMapping
    public AjaxResult add(@Validated @RequestBody MdUnitMeasure mdUnitMeasure) {
    ...
    @PutMapping
    public AjaxResult edit(@Validated @RequestBody MdUnitMeasure mdUnitMeasure) {
